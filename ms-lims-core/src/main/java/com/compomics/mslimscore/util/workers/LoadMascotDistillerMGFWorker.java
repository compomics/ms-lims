...
import com.compomics.mslimscore.util.fileio.mergefiles.MascotDistillerMergeFileReader;
...
public class LoadMascotDistillerMGFWorker extends SwingWorker {
    // Class specific log4j logger for LoadMascotDistillerMGFWorker instances.
    private static Logger logger = Logger.getLogger(LoadMascotDistillerMGFWorker.class);
