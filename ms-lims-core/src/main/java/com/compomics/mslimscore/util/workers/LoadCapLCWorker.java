...
/**
 * This class loads all the LCRuns with PKL files from the directories in the specified folder listing.
 *
 * @author Lennart Martens
 */
public class LoadCapLCWorker extends SwingWorker {
    // Class specific log4j logger for LoadCapLCWorker instances.
     ...
     * @param aNames        Vector that will contain the LCRuns that were picked up as new. <b>Please note</b> that this
     ...
     * @param aCapLCtoFiles HashMap which will contain the LCRun names as Strings as keys, and Vectors with File
     *                      instances as values. It thus provides the list of files per LCRun. <b>Please note</b> that
    ...
    /**
     * This method recurses through the specified folder until it finds pkl files or can no longer find lower
     * directories.
     *
    ...
    /**
     * This method checks whether the lcrun which builds this filename is new, regardless of case.
     *
     * @param aLCRunName   String with the name of the lcrun to check against what has been stored before.
     * @param aStoredCaplc Vector with the stored LCRuns that have been stored before.
     * @return boolean that is 'true' when the lcrun name is new, 'false' when it is already present in the DB.
     */
