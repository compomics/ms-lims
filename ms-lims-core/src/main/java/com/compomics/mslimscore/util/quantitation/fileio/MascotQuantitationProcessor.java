...
import com.compomics.mslimscore.util.fileio.QuantitationXmlReader;
...
// -------------------------- OTHER METHODS --------------------------
    ...
    private void setIdentificationsForActiveSearch() throws SQLException {
        ...
        setIdentifications(getIdentificationExtensionsForDatfile(lDatfileName, lDatfileServer, lDatfileFolder, iConnection));
    }
    ...
    private IdentificationExtension[] getIdentificationExtensionsForDatfile(String lDatfileName, String lDatfileServer, String lDatfileFolder, Connection iConnection) {
        Vector temp = new Vector();
        try{
        ResultSet rs = Datfile.getIdentificationExtensionsForDatfile(lDatfileName, lDatfileServer, lDatfileFolder, iConnection);
        while (rs.next()) {
