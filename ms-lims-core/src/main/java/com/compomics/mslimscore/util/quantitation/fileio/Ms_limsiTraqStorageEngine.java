package com.compomics.mslimscore.util.quantitation.fileio;
...
import com.compomics.mslimsdb.accessors.Quantitation_group;
...
/**
 * Created by IntelliJ IDEA. User: niklaas Date: 25-mrt-2009 Time: 8:06:15
 */
public class Ms_limsiTraqStorageEngine implements QuantitationStorageEngine {
    // Class specific log4j logger for Ms_limsiTraqStorageEngine instances.
    private static Logger logger = Logger.getLogger(Ms_limsiTraqStorageEngine.class);
// ------------------------------ FIELDS ------------------------------
...
// --------------------- Interface QuantitationStorageEngine ---------------------
    ...
    /**
     * The Ms_limsiTraqStorageEngine stores a collection of RatioGroups into the ms_lims system. The dat file will be
     * zipped and persisted and identificationid's are matched from the lims system. <br><br> {@inheritDoc}
     */
