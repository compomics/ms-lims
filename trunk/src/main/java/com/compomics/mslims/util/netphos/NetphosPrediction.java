...
public class NetphosPrediction {
     ...
     *
     * @param aLocation PredcitedLocation with the location, residue and score
     *                  information for the predicted location.
     */
    ...
    /**
     * This method allows the caller to specify a new accession number for the
     * protein.
     *
    ...
    /**
     * This method returns all the predicted phosphorylation locations
     * for this protein.
     *
    ...
    /**
     * This method returns all the predicted phosphorylation locations
     * for this protein that score higher than the provided threshold.
     *
     * @param aThreshold    double with threshold score.
     * @return  Vector  with all the PredictedLocations that have a score
