...
public class CheckboxInput extends AbstractInput {
    ...
    /**
     * The state for a checkbox can be represented by a single boolean:
     * either on, or off.
     */
    private boolean ibChecked = false;

    /**
     * This constructor initializes the checkbox with a name and a value. <br />
     * The value will be submitted if the checkbox state is 'true'; nothing will
     * happen when the state is 'false' (the input is mute).
     *
    ...
    /**
     * This constructor initializes the checkbox with a name, a value and a comment. <br />
     * It is advised to use this constructor as the comment will allow you to tell the user
     * why this checkbox is here and what the value will do. <br />
     * The value will be submitted if the checkbox state is 'true'; nothing will
     * happen when the state is 'false' (the input is mute).
     *
     * @param   aName   this String represents the name of the input.
    ...
    /**
     * This constructor initializes the checkbox with a name, a value, a comment and
     * set the state simultaneously. <br />
     * The value will be submitted if the checkbox state is 'true'; nothing will
     * happen when the state is 'false' (the input is mute).
     *
     * @param   aName   this String represents the name of the input.
    ...
    public String getValue() {
        if(!valueConfirmed) {
            try {
                ...
                if(!silent) {
                    System.out.print("Do you wish to check checkbox '" + comment + "' (default is '");
                    System.out.println((ibChecked?("yes')?"):"no')?"));
                }
    ...
    /**
     * This method allows the caller to set the state of this checkbox without
     * any side effects. It basically sets the default.
     *
     * @param   abChecked   boolean to idicate whether this checkbox input
