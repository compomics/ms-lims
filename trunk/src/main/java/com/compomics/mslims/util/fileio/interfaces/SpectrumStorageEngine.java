...
/**
 * This interface describes the behaviour for a SpectrumStorage implementation.
 * The required functionality can be summed up as allowing Lcrun instances to be read from
 * the filesystem, and to allow the reading of spectrumfiles from the harddrive and transforming
 * these into correct SpectrumFile instances for DB storage.
 *
...
public interface SpectrumStorageEngine {
     ...
     */
    public abstract int loadAndStoreSpectrumFiles(LCRun aLCRun, long aProjectid, long aInstrumentid, Connection aConn) throws IOException, SQLException;
}