 ...
 * to load and store ms/ms data from an ABI 4800 mass spectrometer.
 *
 * This class loads all the MGF MS/MS spectra from a ABI 4800 - T2SMascot output specified folder.
 * A given topfolder contains subfolders for distinct lcruns.
 * Directly in these folders resides an stacked .mgf file for that lcrun(multiple spectra in a single file).
 *
