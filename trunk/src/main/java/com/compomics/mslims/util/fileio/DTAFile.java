...
/**
 * This class maps a DTAFile to memory.
...
public class DTAFile extends SpectrumFileAncestor implements SpectrumFile {
    ...
    /**
     * This constructor takes the DTAFile as a String as read from file or DB.
     * The filename is specified separately here and this filename overrides a
     * filename already present in the dtafile.
     *
    ...
    /**
     * This constructor takes the filename of the DTAFile as argument and
     * loads it form the hard drive. The filename specified for loading the file
     * overrides a filename present in the header of the dtafile.
     *
     ...
     * using its current filename. The filename is NOT mentioned in the DTA file when this
     * method is used.
     *
     ...
     * The filename is NOT mentioned in the DTA file when this
     * method is used.
     *
    ...
    /**
     * This method allows the caller to write the dtafile to the specified folder
