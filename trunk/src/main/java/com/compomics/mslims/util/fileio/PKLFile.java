...
/**
 * This class maps a PKLFile to memory.
 * It allows some searching and retrieval functionality.
 *
...
public class PKLFile extends SpectrumFileAncestor implements SpectrumFile {
    ...
    /**
     * This constructor takes the PKLFile as a String as read from file or DB.
     * The filename is specified separately here and this filename overrides a
     * filename already present in the pklfile.
     *
    ...
    /**
     * This constructor takes the PKLFile as a String as read from file or DB.
     * The filename has to be present as the fourth element in the first line!
     *
     * @param   aContents   String with the contents of the PKLFile.
     */
    ...
    /**
     * This constructor takes the filename of the PKLFile as argument and
     * loads it form the hard drive. The filename specified for loading the file
     * overrides a filename present in the header of the pklfile.
     *
     ...
     * using its current filename. The filename is NOT mentioned in the PKL file when this
     * method is used.
     *
     * @param   aParentDir  File with the parent directory to put the file in.
     * @exception   IOException whenever the write process failed.
     */
     ...
     * The filename is NOT mentioned in the PKL file when this
     * method is used.
     *
    ...
    /**
     * This method returns the runnumber as indicated in the filename of
     * the PKL file (it is the number after 'caplc' and before the first '.').
     *
     * @return  long    with the runnumber, or -1 if no filename was set
     *                  or the filename was not formatted correctly.
     */
    ...
    /**
     * This method returns the scannumber as indicated in the filename of
     * the PKL file (it is the number between the first and second '.').
     *
     * @return  long    with the scannumber, or -1 if no filename was set
     *                  or the filename was not formatted correctly.
     */
    ...
    /**
     * This method checks whether the following variables correspond:
     *  <ul>
     *      <li>Precursor M/Z (exact)</li>
     *      <li>Precursor charge state</li>
     *  </ul>
     *
    ...
    /**
     * This method performs a 'coarser' check of the precurosr mass,
     * meaning that it allows for an error of 0.0001 Da on the precursor mass.
     * <ul>
     *      <li>Precursor M/Z (exact)</li>
     *      <li>Precursor charge state</li>
     *  </ul>
    ...
    /**
     * This method is an elaboration of the 'corresponds' check and should only be used
     * when the corresponds method returns multiple hits, since there are some problems concerning
     * MAscot precision in reporting masses! <br />
     * It checks the following parameters:
     *  <ul>
     *      <li>Precursor M/Z (exact)</li>
     *      <li>Precursor charge state</li>
     *      <li>lowest peak mass with an allowed error of 0.2 Da</li>
     *      <li>highest peak mass with an allowed error of 0.2 Da</li>
     *  </ul>
     *
     * @param   aMIS   MascotIdentifiedSpectrum to compare to.
     * @return  boolean which indicates whether these objects correspond.
     ...
     * @param   aOut    OutputStream to write the file to. This Stream
     *                  will <b>NOT</b> be closed by this method.
     * @param   aWriteFilename  if this boolean is true, the filename is appended
     *                          as the fourth element in the header. If it is false,
     *                          the filename is ommitted.
     * @exception   IOException when the write operation fails.
     */
    ...
    /**
     * This method allows the caller to write the pklfile to the specified folder
    ...
    /**
     * This method will parse the data from the specified String with
