...
public class UltraflexXMLFile extends SpectrumFileAncestor {
    ...
    /**
     * This constructor creates an in-memory representation of the
     * specified Ultraflex XML file.
     *
     ...
     * @return Double   with the last key that was added to the peak list.
     *                  This peak is the precursor.
    ...
    /**
     * This method extracts the precursor mass from the pathname, based on the fact that the
     * foldername with the mass ends with '.LIFT.LIFT'.
     *
