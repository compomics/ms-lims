...
/**
 * Created by IntelliJ IDEA. User: Niklaas Date: 15-Jan-2010 Time: 13:14:56 To change this template use File | Settings
 * | File Templates.
 */
public class Quantitation_group extends Quantitation_groupTableAccessor {
    // Class specific log4j logger for Quantitation_group instances.
     ...
     * in this order: <br /> Column 1: quantitation_grouid <br /> Column 2: l_quantitation_fileid <br /> Column 3:
     * file_ref <br /> Column 4: username <br /> Column 5: creationdate <br /> Column 6; modificationdate. <br />
     *
