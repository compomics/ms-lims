 ...
 * <p/>
 * <ul> <li><i>constructor</i>: to read a single User from a ResultSet.</li> <li><b>toString()</b>: returns the name of
 * the user.</li> </ul>
 *
 * @author Lennart Martens
 */
public class User extends UserTableAccessor {
    // Class specific log4j logger for User instances.
    ...
    /**
     * This constructor reads a User from a ResultSet. The ResultSet should be positioned such that a single row can be
     * read directly (i.e., without calling the 'next()' method on the ResultSet). <br /> The columns should be in this
     * order: <br /> Column 1: user ID <br /> Column 2: name <br /> Column 3: username <br /> Column 4: creationdate <br
    ...
    /**
     * This method retrieves all users from the connection and stores them in a HashMap. <br /> The userid is the key
     * (Long type) and the User object is the value.
     *
