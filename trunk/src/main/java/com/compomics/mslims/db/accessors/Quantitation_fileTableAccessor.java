...
public class Quantitation_fileTableAccessor implements Deleteable, Retrievable, Updateable, Persistable {
	...
	/**
	 * This constructor allows the creation of the 'Quantitation_fileTableAccessor' object based on a set of values in the HashMap.
	 *
	...
	/**
	 * This constructor allows the creation of the 'Quantitation_fileTableAccessor' object based on a resultset
	 * obtained by a 'select * from Quantitation_file' query.
	 *
