...
public class Projectanalyzertool extends ProjectanalyzertoolTableAccessor {
    ...
    /**
     * This constructor reads the projectanalyzertool from a resultset. The ResultSet should be positioned such that
     ...
     *
     * Column 1: projectanalyzertoolid <br />
     * Column 2: tool name <br />
     * Column 3: description <br />
     * Column 4: toolclassname <br />
     * Column 5: toolparameters <br />
     ...
     * @param   aSortedByToolName boolean to indicate whether the returned array should be
     *          sorted alphabetically by the tool name. Sorts when 'true', and returns default
     *          DB ordering (typically 'creationdate') when 'false'.
