...
public class QuantitationTableAccessor implements Deleteable, Retrievable, Updateable, Persistable {
	...
	/**
	 * This constructor allows the creation of the 'QuantitationTableAccessor' object based on a set of values in the HashMap.
	 *
	...
	/**
	 * This constructor allows the creation of the 'QuantitationTableAccessor' object based on a resultset
	 * obtained by a 'select * from Quantitation' query.
	 *
