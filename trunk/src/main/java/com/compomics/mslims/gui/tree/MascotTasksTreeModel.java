...
/**
 * This class presents a TreeModel implementation for the Tree with the
 * Mascot tasks and searches.
 * 
...
public class MascotTasksTreeModel implements TreeModel {
    ...
    /**
     * This Vector will hold all the searches done.
     * key
     */
    private Vector iTasks = null;

    /**
     * This constructor takes a list of MascotTask instances that
     * have been retrieved from the database.
     *
     * @param aMascotTasks  Vector with all the Mascot tasks that
     *                      were retrieved from the TaskDB.
     */
