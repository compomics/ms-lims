...
public class DifferentialProjectTableModel extends AbstractTableModel {
    ...
    /**
     * This method reports whether a project with the specified ID and title
     * is already present in the model.
     *
     * @param aId   long with the project ID.
     * @param aTitle    String with the project title.
     * @return  boolean that is 'true' if the model already contains
     *                  such a project, or 'false' otherwise.
     */
