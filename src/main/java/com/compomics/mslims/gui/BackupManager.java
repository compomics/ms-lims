...
/**
 * This class implements a GUI for LCRun back-up management using the 'dvd_master_number' and 'dvd_secondary_number'
 * columns in the LCRun table.
 *
...
public class BackupManager extends JFrame implements Connectable, Flamable {
    ...
    /**
     * This variable holds the identified for the DB connection, typically the name of the database that has been
     * connected.
     */
    ...
    /**
     * This method displays a JOptionPane with the choices for storage that the user has. Currently, these are either CD
     * or DVD.
     */
