...
public class QuantitationCellRenderer extends DefaultTableCellRenderer {
    ...
    /**
     * Returns the component used for drawing the cell.  This method is used to configure the renderer appropriately before
     * drawing.
     *
     ...
     *                   value.  For example, if <code>value</code> is the string "true", it could be rendered as a string
     *                   or it could be rendered as a check box that is checked.  <code>null</code> is a valid value
