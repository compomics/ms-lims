...
public class iTraqMs_limsStorageGui extends JFrame implements Connectable, Flamable {
    ...
    private void previewStorage() {
        ...
        try {
            PreparedStatement prep = iConn.prepareStatement("select i.l_datfileid from identification as i , spectrumfile as s where i.l_spectrumfileid = s.spectrumfileid and s.l_projectid = ? group by i.l_datfileid");
