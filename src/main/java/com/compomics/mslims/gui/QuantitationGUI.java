...
/**
 * This class will present the user with a graphical user interface to read search results from
 * the Mascot Daemon Task Database and preview the processed results in the s_lims DB.
 *
...
public class QuantitationGUI extends JFrame implements Connectable, Flamable {
    ...
    /**
     * This constructor takes the title for the frame, the DB connection to use,
     * and a name for this connection.
     *
     * @param aName String with the title for the frame.
    ...
    /**
     * This method initializes all components on the GUI
     * and lays them out.
     */
