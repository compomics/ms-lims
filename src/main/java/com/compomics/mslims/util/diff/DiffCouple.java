...
public class DiffCouple {
    ...
    /**
     * After statistical analysis, this field will hold the
     * result of '(µ-mean)/stdev'. It can therefore be readily compared
     * to a normal significance interval, since the statistical
     * analysis should yield a µ and stdev such that N~(µ, stdev).
     */
    ...
    /**
     * Modified sequence of the peptide (comma-separated list of mod seqs
     * if more than one spectrum contributed.
     */
    ...
    /**
     * This Vector will contain all original DiffCouples that were added to this
     * DiffCouple.
     */
    ...
    /**
     * This constructor builds a minimalist DiffCouple that can be used for data storage.
     * In this case, we only need the filename (primary key) and light and heavy intensities.
     *
     ...
     * as well as the modified sequence of the added couple.
     *
    ...
    /**
     * This method returns a Vector with all the merged entries that constitute
     * this DiffCouple. The Vector is empty when the count for this DiffCouple is '1'.
     *
    ...
    /**
     * This method reports on the light/heavy ratio for the peptide.
     * It uses the default method of weighted ratios for calculating
     * the ratio of a clustered DiffCouple.
     *
    ...
    /**
     * This method reports on the light/heavy ratio for the peptide. When this DiffCouple
     * represents a cluster, the ratio is calculated as the ratio of the summed intensities of
    ...
    /**
     * This method reports on the light/heavy ratio for the peptide. When this DiffCouple
     * represents a cluster, the ratio is calculated as the average of the individual ratios.
     *
     * @return  double with the light/heavy ratio.
     */
     ...
     * When this DiffCouple represents a cluster, the ratio is calculated as the ratio of the
     * weighted ratios of the cluster elements.
     *
     ...
     * This method reports on the light/heavy ratio for the peptide, transformed in log2 scale.
     *
     * When this DiffCouple represents a cluster, the ratio is calculated as the average of
    ...
    /**
     * This method reports on the light/heavy ratio for the peptide, transformed in log2 scale.
     * It uses the default method of weighted ratios for calculating the ratio of
     * a clustered DiffCouple.
     *
     * @return  double with the log(base 2) light/heavy ratio.
     */
    ...
    /**
     * This method checks whether this DiffCouple has a ratio that is significantly different from
     * the normal distribution detailed by the given location and scale.
     *
     * @return  int that is '98' for a ratio that has a different ratio at the 98% confidence interval,
     *              '95' for the 95% confidence interval and '0' when the ratio is not significantly
     *              different.
     */
    ...
    /**
     * This method checks if the specified DiffCouple (which should be representing a cluster!)
     * has a set of ratios that contains an outlier on the 95% confidence interval. Location is the median,
     * scale the Huber scale estimator. The 95% confidence interval results in a test Z-value of 1.96.
     *
     * @return  int that is '98' for a clustered diffcouple that has outlying ratios in its composition
     *              at the 98% confidence interval, '95' for the 95% confidence interval and '0' when no
    ...
    /**
     * This method calculates a robust location (median) and scale (Huber scale)
     * estimate for this clustered couple.
     *
    ...
    /**
     * When a DiffCouple represents a cluster, this method will return the sum of all heavy intensities.
     * If it is not a cluster, the result will be identical to the result of getHeavyIntensity().
     *
    ...
    /**
     * When a DiffCouple represents a cluster, this method will return the sum of all light intensities.
     * If it is not a cluster, the result will be identical to the result of getLightIntensity().
     *
    ...
    /**
     * This method returns 'true' only if the ratio can not be calculated (one of the intensities
