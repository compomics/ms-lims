...
public class RadioInput extends AbstractInput {
    ...
    /**
     * This constructor initializes a name for the group, a default selection
     * and a Vector of choices.
     *
     * @param   aName   String with the name for the group.
     * @param   aDefault   String with the default selection for the group.
     * @param   aChoices   Vector with the choices for the group.
    ...
    /**
     * This method sets the default on this group. <br />
    ...
    /**
     * This method allows for the adding of a choice that automatically
     * becomes the default choice, overriding all earlier settings. <br />
     * This default has to be verified by the user before it is set as the
     * definitive value.
     *
     * @param   aChoice String value for the choice to add to a group
            ...
            try {
                ...
                if(!silent) {
                    ...
                    for(int i=0;i<liSize;i++) {
                        System.out.println(" - '" + choices.elementAt(i) + "'");
                    }
                }
