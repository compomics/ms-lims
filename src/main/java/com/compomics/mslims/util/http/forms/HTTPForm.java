...
import com.compomics.mslims.util.http.forms.parsers.FormToObjectParser;
...
/**
 * In theory, this class is usable to parse any HTML form into a collection of
 * InputInterface implementations that allow for the selection of values
 * in a programmatic context rather than an HTML context. <br />
 * Value initialization can be done automatically when one requests the HTTP post
 * header, used to submit this form. <br />
 * If the correct content types etc. are set (at your leisure in the caller of this
 * class), the POST String can be submitted as the body of the HTTP request to complete
 * the cycle. <br />
 * The class behaves like a Factory for itself (static methods for getting an instance),
 * but it has public constructors as well if you would like to use them (for instance,
 * when you write your own form parser).
 * <b>PLEASE NOTE</b> that the current underlying parser specializes in Mascot
 * search forms for the retrieval of appropriate 'comment' lines for the inputs.
 * This is an issue of the parser, not the form!!
 * This format consists of a table, where each cell holds an input and possibly
 * a comment (as an ANCHOR tag!!). Only RadioButtons escape this.
 *
...
public class HTTPForm {
    ...
    /**
     * This boundary is what will seperate fields in the POST request (MIME encoding).
     * Note that it is FINAL!
     * I guess it suffices for most applications, since the only real condition is that
     * this String does not appear anywhere in the request, save as boundary.
     */
    private static final String BOUNDARY = "---------------ArCo5BaLeNo4DoVe3Il2VaTiCaNo1?";

    /**
     * Default constructor which just initializes the vars to empty, yet usable
     * values.
     */
    public HTTPForm() {
    ...
    /**
     * Constructor to initialize a Form with the given InputInterface implementations,
     * yet without any Form parameters.
     *
    ...
    /**
     * This constructor initializes the InputInterface implementations on this HTTPForm
     * as well as setting all the parameters for the form. <br />
     * Typically, this constructor is called by the parser, as you will probably
     * call the static factory methods (which will invoke the parser for you).
     */
    ...
    /**
     * Probably the factory method of choice for getting an HTTPForm object
     * from an actual form. Just give it the URl and let the default parser
     * sort it out.
     *
     ...
     * @exception   IOException when reading the stream causes unexpected problems.
     */
    ...
    /**
     * Probably not the easiest factory method to use. It allows you to parse a form
     * from an InputStream, using the default parser.
     *
    ...
    /**
     * This method allows you to search for an InputInterface implementation
     * by its name.
     *
     * @param   aName   String with the name of the input
     * @return  InputInterface  which is the implementation if found,
     *                          'null' otherwise.
     */
    ...
    /**
     * This method returns a String representation of the current form. <br />
     * Most notably, reporting on the form parameters and all the inputs.
     *
    ...
    /**
     * This method returns header settings as generated by Microsoft Internet
     * Explorer 6.0, nl-be locale, on Windows XP Professional.
     *
    ...
    /**
     * This method reports on the submission String you an use as the body
     * for an HTTP POST request. <br />
     * It automatically polls the inputs for their values, and the inputs
     * will now whether to call the user for input.<br />
    ...
    /**
     * This method is present for testing purposes only. <br />
     * The arguments are NOT used and you probably don't want to call
     * this method as it will not find the file it's looking for and
     * simply exit.
     */
    public static void main(String[] args) {
        try {
            HTTPForm hf = HTTPForm.parseHTMLForm(new FileInputStream("G:/temp.html"));
            System.out.println(hf.getSubmissionString());
        } catch(Exception e) {
            e.printStackTrace();
        }
    }
