...
public class LoadDTAWorker extends SwingWorker {
    // Class specific log4j logger for LoadDTAWorker instances.
    private static Logger logger = Logger.getLogger(LoadDTAWorker.class);
    ...
    /**
     * This method attempts to find dta spectra in the specified folders, if it does find them, the folder above the dta
     * files (the parent of those files) is considered to be the LCRun, the count of files is added to this and the
     * process continues. Note that this method recurses.
     *
