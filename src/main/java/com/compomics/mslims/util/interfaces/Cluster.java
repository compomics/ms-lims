...
public interface Cluster {
    ...
    /**
     * This method should return the number of spectra that were grouped to form
     * this cluster. A valid return value is any positive, non-zero integer.
     *
     * @return  int with the number of spectra in this cluster. Result should be a
     *              positive, non-zero integer.
     */
    public abstract int getSpectrumCount();

    /**
     * This method returns the spectra that this cluster is composed of as an array
     * of SpectrumFile instances.
     *
