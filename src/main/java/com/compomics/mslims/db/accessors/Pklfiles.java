...
/**
 * This class adds three useful methods to the PklfilesTableAccessor class:
 * <ul>
 *   <li><b>getUnzippedFile()</b>: returns the pklfile as a stream of unzipped bytes.</li>
 ...
 * </ul>
 * And a constructor which can create a pklfile from a ResultSet.
 *
...
public class Pklfiles extends PklfilesTableAccessor {
     ...
     * Column 1: filename <br />
     * Column 2: GZIPped bytes for the file. <br />
     * Column 3: number of identifications. <br />
     * Column 4: creationdate.
     *
