...
public class Filedescriptor extends FiledescriptorTableAccessor {
    ...
    /**
     * This constructor reads the filedescriptor from a resultset. The ResultSet should be positioned such that
     ...
     *
     * Column 1: filedescriptorid <br />
     * Column 2: short label <br />
     ...
     * @param   aSortedByShortLabel boolean to indicate whether the returned array should be
     *          sorted alphabetically by the short labels. Sorts when 'true', and returns default
