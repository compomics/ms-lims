...
public class Identification_to_quantitationTableAccessor implements Deleteable, Retrievable, Updateable, Persistable {
    // Class specific log4j logger for Identification_to_quantitationTableAccessor instances.
    private static Logger logger = Logger.getLogger(Identification_to_quantitationTableAccessor.class);
