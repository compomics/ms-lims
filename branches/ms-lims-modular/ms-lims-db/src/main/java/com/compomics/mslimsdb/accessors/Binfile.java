...
/**
 * This class adds XXX useful methods to the BinfileTableAccessor class: <ul> <li><b>getUnzippedFile()</b>: returns the
 * binfile as a stream of unzipped bytes.</li> <li><b></b>setUnzippedFile(byte[] aBytes): allows the setting and
...
public class Binfile extends BinfileTableAccessor {
    // Class specific log4j logger for Binfile instances.
    private static Logger logger = Logger.getLogger(Binfile.class);
    ...
    /**
     * This constructor reads the binary file from a resultset. The ResultSet should be positioned such that a single
     * row can be read directly (i.e., without calling the 'next()' method on the ResultSet). The columns should be in
     * this order: <br /> Column 1: binfile ID <br /> Column 2: l_project ID <br /> Column 3: l_filedescription ID <br
     * /> Column 4: GZIPped or ZIPped bytes for the file or folder <br /> Column 5: filename <br /> Column 6: comments
     * <br /> Column 7: originalpath <br /> Column 8: originalhost <br /> Column 9: originaluser <br /> Column 10:
     * username <br /> Column 11: creationdate <br /> Column 12: modificationdate.
     *
    ...
    /**
     * This method writes the unzipped contents of this binfile (whether file or folder) to the specified destination
     * folder. <b>Note</b> that it silently overwrites any pre-existing files! Existence checks should be handled by the
     * caller!
     *
    ...
    /**
     * This method writes the unzipped contents of this binfile to the specified folder, using the original filename.
     * <b>Note</b> that it silently overwrites any pre-existing files! Existence checks should be handled by the
     * caller!
     *
    ...
    /**
     * This method will write the unzipped contents of this ZIPped data stream to the specified folder. If the contents
     * of this binfile do not represent a folder ('isFolder()' returns 'false'), a RuntimeException will be thrown!
     *
     * @param aParentDestination File with the parent folder to write the unZIPped folder to. This File must represent a
     *                           directory!
     * @throws java.io.IOException when the unzipping process goes wrong.
     */
     ...
     *
     * @param aBytes byte[] with the data for the binary file. This data will be zipped and subsequently sent to the
     *               superclass.
     ...
     * @throws java.io.IOException whenever the file could not be found, could not be read or could not be zipped.
     */
    ...
    /**
     * This methods reads all binary files for the specified project from the Binfile table, without loading the BLOB
     * itself. The BLOB can be loaded by calling 'loadBLOB' on the instance for which the file needs to be loaded.
     *
    ...
    /**
     * This method initializes the 'iFile' property of this Binfile, provided that the 'iBinfileid' property is
     * correctly initialized. It is best used in conjunction with a lazy loading method.
     *
     ...
     * @throws java.io.IOException whenever the GZIPping process fails.
     */
     ...
     *
     * @return boolean that is 'true' when the stored data represents a folder, or 'false' when it represents a single
     *         file.
     */
     ...
     *
     * @return boolean that is 'true' when the stored data represents a single file, or 'false' when it represents a
     *         folder.
     */
