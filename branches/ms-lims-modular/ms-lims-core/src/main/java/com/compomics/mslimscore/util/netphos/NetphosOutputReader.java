...
public class NetphosOutputReader {
    // Class specific log4j logger for NetphosOutputReader instances.
     ...
     * @throws IOException when the input file could not be parsed.
     */
    ...
    /**
     * This method returns a HashMap with protein accession Strings as keys, and all the predictions for the protein as
     * values. <br />
     *
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            if (threshold >= 0) {
                logger.info(nor.toString(threshold));
            } else {
                logger.info(nor.toString());
            }
