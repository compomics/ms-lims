            ...
            while (rs.next()) {
                ...
                try {
                    if (lOldStorageClassName != null) {
                        String lNewStorageClassName = lOldStorageClassName.replace("be.proteomics.lims", "com.compomics.mslimscore");
            ...
            while (rs.next()) {
                ...
                try {
                    if (lOldToolclassname != null) {
                        String lNewToolclassname = lOldToolclassname.replace("be.proteomics.lims", "com.compomics.mslimscore");
