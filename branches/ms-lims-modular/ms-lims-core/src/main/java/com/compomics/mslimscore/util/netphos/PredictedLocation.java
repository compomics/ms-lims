...
public class PredictedLocation {
    // Class specific log4j logger for PredictedLocation instances.
    private static Logger logger = Logger.getLogger(PredictedLocation.class);
    ...
    /**
     * This construct takes all relevant information for a phosphorylation predicted as reported by Netphos.
     *
    ...
    /**
     * This method test whether the Object specified is the same predicted location as this one.
     *
